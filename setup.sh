...
echo "$CURRENT_DIR/config/ghostty -> $HOME/.config/"
ln -is "$CURRENT_DIR/config/ghostty" "$HOME/.config/"

echo "$CURRENT_DIR/config/zellij -> $HOME/.config/"
ln -is "$CURRENT_DIR/config/zellij" "$HOME/.config/"
